...
class Solver():
    ...
    def _printState(self):
        ...
        printClauses(self, assigned=lambda x: self._valueLit(x) != cst.lit_Undef,
                     value=lambda x: self._valueLit(x) == cst.lit_True)
    ...
    def printStats(self):
        ...
        print("c propagations: " + str(self._propagations) + " (" + str(
            int(self._propagations / self._searchTime)) + "/s)")
